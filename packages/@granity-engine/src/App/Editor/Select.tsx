...
function Select({
    ...
    React.useEffect(() => {
        ...
        function onSelectStart(event) {
            ...
            isDown = true;
            (_gl$domElement$parent = gl.domElement.parentElement) == null
                ? void 0
                : _gl$domElement$parent.appendChild(element);
        ...
        function onSelectOver() {
            if (isDown) {
                ...
                isDown = false;
                (_element$parentElemen = element.parentElement) == null
                    ? void 0
                    : _element$parentElemen.removeChild(element);
            }
        }
